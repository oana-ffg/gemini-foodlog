...
See the judge-facing [Devpost submission copy and test plan](./docs/devpost-submission.md), [four-minute demo runbook](./docs/demo-runbook.md), [production architecture diagram](./docs/architecture-diagram.md), working [MVP architecture and decision record](./docs/mvp-architecture.md), [setup and deployment guide](./docs/deployment.md), [credit-expiry runbook](./docs/credit-expiry-runbook.md), [judge-availability runbook](./docs/judge-availability-runbook.md), [source-controlled MVP backlog](./docs/mvp-backlog.html), and [historical preview record](./infra/preview/README.md). The original proposal is preserved verbatim in [CORE_IDEA.md](./CORE_IDEA.md).
